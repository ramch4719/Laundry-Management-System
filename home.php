	...
	<div class="row mt-3 ml-3 mr-3">
			...
			<div class="card">
				...
				<hr>
					...
					echo $laundry->num_rows > 0 ? number_format(floatval($laundry->fetch_array()['amount']),2) : "0.00";
				...
				<hr>
					...
					echo $laundry->num_rows > 0 ? number_format(floatval($laundry->fetch_array()['count'])) : "0";
